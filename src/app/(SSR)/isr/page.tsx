...
export const metadata = {
    title: "Random Image",
    description: "A random image from Unsplash incremental static regeneration",
};
...
export default async function Page() {
    ...
    return (
        <div className="d-flex flex-column align-items-center">
            <Alert>This page <strong>fetches and caches data in a certain frequency</strong></Alert>
             <Image
